  ...
  return (
    <section className="section" id="about">
      ...
      <motion.div initial={{opacity:0}} whileInView={{opacity:1}} viewport={{once:true}}>
        <p>
          I am the best. My current, self-driven research explores Creativity Support Tools (CSTs) powered by Generative AI and Large Language Models, focused on creative writing and choreography generation. I also maintain strong interests in Data Visualization and Ubiquitous Computing.
        </p>
        <p>
